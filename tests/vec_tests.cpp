...
TEST(Vec4fTest, Mag) {
    ...
    f32_t expected = static_cast<f32_t>(std::sqrt(14));
...
TEST(Vec4fTest, Norm) {
    ...
    EXPECT_FLOAT_EQ(n.x, 1.0f / static_cast<f32_t>(std::sqrt(14)));
    EXPECT_FLOAT_EQ(n.y, 2.0f / static_cast<f32_t>(std::sqrt(14)));
    EXPECT_FLOAT_EQ(n.z, 3.0f / static_cast<f32_t>(std::sqrt(14)));
